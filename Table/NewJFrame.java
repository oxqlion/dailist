...
public class NewJFrame extends javax.swing.JFrame {
        ...
        while (data != null) {
            if (data.contains(user)) {
                ...
                if (deleteData == count - 1) {
                    System.out.println("Data yang ingin Anda edit adalah " + st.nextToken());
                    isDelete = true;
                    isFound = true;
                }
    ...
    private void TambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TambahActionPerformed
        ...
        String peopleDisplay = "[" + User + ", " + people + "]";
        ...
        try {
            ...
            String data[] = {judulKegiatan, tanggal, due, jenisKegiatan, prioritasKegiatan, sisaWaktu, progress, peopleDisplay};
